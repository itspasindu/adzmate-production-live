...
| 1.5 | Migration run in CI + deploy pipeline | `.github/workflows/` |
...
| 1.25 | Staging environment live (existing GHCR pipeline) | `docs/STAGING_CICD.md` |
...
| 3.19 | CI: block merge if tests fail | `.github/workflows/ci.yml` |
...
| CI | `.github/workflows/ci.yml` | pytest + E2E jobs |
